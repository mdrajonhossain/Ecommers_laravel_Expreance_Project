    ...
    <div class="p-2 flex justify-between h-16 items-center gap-10">
        ...
        <div class="flex-grow mx-4 md:block hidden">
            <div class="flex items-center bg-green-800 rounded-lg overflow-hidden">
                ...
                <button class="pr-5 pl-5 pt-2 pb-2 bg-green-700 hover:bg-sky-600 text-white rounded-r-lg">
        ...
        <div class="flex items-center relative">
            <div class="ml-4 flex items-center gap-2">
                ...
                <!-- heart Icon -->
                <button class="p-2 text-white relative hover:bg-sky-600">
                ...
                <!-- Logout Button -->
                <button id="logout-button" class="p-2 text-white relative hover:bg-sky-600">
